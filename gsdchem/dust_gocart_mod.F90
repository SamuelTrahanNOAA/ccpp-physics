...
!
    ...
    real(kind=kind_phys),parameter::max_default=0.
...
! ****************************************************************************
  ...
  REAL(kind=kind_phys) :: den(nmx), diam(nmx)
  REAL(kind=kind_phys) :: rhoa, tsrc, u_ts0, u_ts, dsrc, srce
  ...
  REAL(kind=kind_phys), PARAMETER :: gthresh = 0.5_kind_phys
