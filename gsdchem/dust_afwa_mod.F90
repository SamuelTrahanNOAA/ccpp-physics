...
! ****************************************************************************
  ...
  REAL(kind_phys)    :: u_ts0, u_ts, dsrc, srce, dmass, dvol_tot
...
!
!  REAL(kind_phys), PARAMETER :: alpha=1.8E-8  ! (m^-1)
...
! they're doing. - GC
  ...
  REAL(kind_phys), PARAMETER :: lambda=12.0D-6   ! crack propogation length (m)
