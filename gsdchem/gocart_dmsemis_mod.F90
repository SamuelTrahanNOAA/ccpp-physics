  ...
  IMPLICIT NONE
   ...
   REAL(kind_phys),  DIMENSION( : , : )                   ,               &
          INTENT(IN   ) ::                                                 &
                                                     ...
                                                     v10,                  &
                                                area,xland
   real(kind_phys), intent(in) :: g,dt,mwdry
...
!
  ...
  real(kind_phys), DIMENSION (1,1,1,1) :: tc
  real(kind_phys), DIMENSION (1,1,1) :: bems,airmas
  real(kind_phys), DIMENSION (1,1) :: emsdms
  real(kind_phys), dimension (1,1) :: w10m,gwet,airden,tskin,dmso
  real(kind_phys), dimension (1) :: dxy
  real(kind_phys),parameter::max_default=1.e-30
!
! number of dust bins
!
  imx=1
