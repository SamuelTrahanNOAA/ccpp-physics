...
!!
      subroutine GFS_MP_generic_pre_run(im, levs, ldiag3d, qdiag3d, do_aw, ntcw, nncl, ntrac, gt0, gq0, save_t, save_q, num_dfi_radar, errmsg, errflg)
!
...
!> @{
      subroutine GFS_MP_generic_post_run(im, levs, kdt, nrcm, ncld, nncl, ntcw, ntrac, imp_physics, imp_physics_gfdl,     &
        ...
        dtend, dtidx, index_of_temperature, index_of_process_mp,ldiag3d, qdiag3d, lssav, num_dfi_radar,                   &
        fh_dfi_radar, ix_dfi_radar, dfi_radar_tten, radar_tten_limits, dt3dt_dfi_radar, fhour, errmsg, errflg)
!
      use machine, only: kind_phys
      ...
      integer :: i, k, ic, itrac, idtend, itime
