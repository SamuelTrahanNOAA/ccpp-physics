...
!!
!! This lake scheme was taken from module_sf_lake in WRF 4.3.1, which
!! modified it from the Community Land Model, version 4.5. The
!! original WRF documentation said:
!!
