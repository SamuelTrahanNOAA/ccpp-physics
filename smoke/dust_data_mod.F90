module dust_data_mod
  ...
  real(kind_phys), dimension(ndust, 12)        :: ch_dust   = 0.8e-09_kind_phys
...
!                0.45,0.50,0.45,9999.0
  ...
  real(kind_phys) :: dust_alpha = 0.
  real(kind_phys) :: dust_gamma = 0.
  ...
  real(kind_phys), dimension(max_soiltyp) :: &
  ...
  real(kind_phys), dimension(maxstypes) :: porosity
